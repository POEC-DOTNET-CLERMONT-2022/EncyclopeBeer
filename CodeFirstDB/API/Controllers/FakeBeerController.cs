...
namespace API.Controllers
{
    ...
    public class FakeBeerController : ControllerBase
    {
        ...
        public ActionResult<BeerDto> Get(Guid id) // Action Result permet de renvoyer un type et/ou un code d'errur
        {
        ...
        public BeerDto Get([FromQuery]string name) // Query pour test
        {
