...
namespace Ipme.WikiBeer.Tools
{
    public class DataBaseRessource
    {
        ...
        public BeerDataManager BeerManager { get; set; }
        public BreweryDataManager BreweryManager { get; set; }
        public CountryDataManager CountryManager { get; set; }
        public StyleDataManager StyleManager { get; set; }
